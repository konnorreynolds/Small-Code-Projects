...
public class ObstacleAvoidance
{
    ...
    public static class Obstacle
    {
        ...
        public Distance radius, width, height;
        ...
        public Obstacle(Translation2d position, Distance radius)
        {
        ...
        public Distance effectiveRadius(Translation2d robotVelocity)
        {
    ...
    {
        // Speed limits
        public LinearVelocity maxVelocity = MetersPerSecond.of(4.0);
        public LinearVelocity minVelocity = MetersPerSecond.of(0.3);
        public AngularVelocity maxAngularVelocity = RadiansPerSecond.of(2.0 * Math.PI);
        ...
        public Distance defaultAvoidanceRadius = Meters.of(1.2);
        public Distance dangerRadius = Meters.of(0.4);
        ...
        // Zones
        public Distance fastZone = Meters.of(2.0);
        public Distance slowZone = Meters.of(0.5);
        public Distance precisionZone = Meters.of(0.15);
    ...
    public static Obstacle circle(Translation2d pos, Distance radius)
    {
        return new Obstacle(pos, radius);
    }

    public static Obstacle rectangle(Translation2d center, Distance width, Distance height)
    {
        Obstacle o = new Obstacle(center, width.div(2.0));
    ...
    public static Obstacle square(Translation2d center, Distance side)
    {
    ...
    public static Obstacle boundary(Translation2d pos, Distance size)
    {
    ...
    public static Obstacle soft(Translation2d pos, Distance radius)
    {
    ...
    public static Obstacle zone(Translation2d center, Distance radius)
    {
    ...
    public static Obstacle ellipse(Translation2d center, Distance rx, Distance ry)
    {
    ...
    public static Obstacle line(Translation2d start, Translation2d end, Distance thickness)
    {
        Translation2d center = start.plus(end).div(2.0);
        Obstacle o = new Obstacle(center, thickness.div(2.0));
        o.shape = Obstacle.Shape.RECTANGLE;
    ...
    public static Obstacle temporary(Translation2d pos, Distance radius, double ttl)
    {
                               ...
                               List<Obstacle> obstacles, PIDController rotationPID, Config config, Translation2d currentVel)
    {
        ...
        for (Obstacle obs : obstacles)
        {
            ...
            Distance effectiveRadius = config.useVelocityAwareAvoidance

...
namespace constants {
    ...
    inline constexpr double SQRT3 = 1.73205080756887729352744634150587237;
    ...
    inline constexpr double FEET_TO_METERS = 0.3048;  // Exact by definition
    inline constexpr double INCHES_TO_METERS = 0.0254;  // Exact by definition

    // Physical constants
    inline constexpr double GRAVITY_EARTH = 9.80665;  // m/s² (standard gravity)
